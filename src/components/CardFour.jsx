  ...
  return (
    <div className={className}>
      <div className="min-h-[735px] max-xl:min-h-[600px] max-lg:min-h-[420px] w-full flex justify-center max-w-[1140px] mx-auto gap-4 max-lg:flex-col">
        <div className="bg-[#026070] py-4 px-[16px] min-h-[735px] max-xl:min-h-[600px] max-lg:min-h-[420px] max-w-[520px] max-lg:max-w-none w-full rounded-2xl flex flex-col gap-[77px] items-center justify-center max-lg:gap-14">
        ...
        <div className="bg-[url(/assets/images/section-four-bg.webp)] bg-cover bg-no-repeat bg-center min-h-[735px] max-xl:min-h-[600px] max-lg:min-h-[420px] max-w-[520px] max-lg:max-w-none w-full rounded-2xl flex justify-center items-center">
          <Image
            width={633}
            height={553}
